...
# Note on reproducability: This code will only (as far as I know) run on linux systems (and I can only guarantee ubuntu). This is a blog post, so reproducabiity is not a big deal, but I'm working on incorporating best practices into my work. Hence this note.
```
