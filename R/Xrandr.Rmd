...
With the new found power of the command line we'll update the google: ["change primary monitor ubuntu command line"](https://superuser.com/questions/155004/switch-monitors-from-the-command-line). And there we go; the top answer is the solution I came to using xrandr. Excellent. At this point, I was spinning around in my chair celebrating, scaring my cats away, thinking I was done finally. I copied the command into my terminal^[Pro(ish) tip: ctrl-c, and ctrl-v don't work in the terminal because the terminal was build before windows ever created those commands. Instead use ctrl-shift-c/v or middle click to copy paste.], ran it and went on with my day. 

Sadly, upon reboot my monitors swapped back and I despaired thinking I would have to type the xrandr command into my terminal every time I booted up the computer. 
